...
/**
 * KvFormPage component for rendering the KV form page.
 ...
 * @returns {JSX.Element} - JSX element representing the KV form page.
 */
const KvFormPage = ({ uuid, portfolio, environment }) => {
  ...
  formsData.kvFormData.fields.find(field => field.name === 'resource_group_key').selectionList = getDataWithKey('rg');

  // Create a new submitRef for the form
  formsData.kvFormData.submitRef = useRef();
