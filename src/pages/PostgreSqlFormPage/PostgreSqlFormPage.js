...
/**
 * KvFormPage component for rendering the PostgreSQL form page.
 ...
 * @returns {JSX.Element} - JSX element representing the PostgreSQL form page.
 */
const PostgreSqlFormPage = ({ uuid, portfolio, environment }) => {
  ...
  formsData.pgsqlFormData.fields.find(field => field.name === 'resource_group_key').selectionList = getDataWithKey('rg');

  // Create a new submitRef for the form
  formsData.pgsqlFormData.submitRef = useRef();
...
export default PostgreSqlFormPage;
